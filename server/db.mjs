...
async function getSanctionRequestRow(pool, clubCode, requestId) {
...
function ensureEditableSanctionRequest(row) {
...
function mapSanctionRequestDetail(row) {
  return {
    id: String(row.id),
    club: {
      clubCode: text(row.clubcode),
...
function normalizePaymentTypes(value) {
